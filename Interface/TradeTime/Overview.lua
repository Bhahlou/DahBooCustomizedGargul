...
function Overview:build()
    ...
    do -- [[ ACTION BUTTONS ]]
        ...
        NormalTexture:SetTexture("Interface/AddOns/DahBooCustomizedGargul/Assets/Buttons/eye");
        ...
        HighlightTexture:SetTexture("Interface/AddOns/DahBooCustomizedGargul/Assets/Buttons/bag");
        NormalTexture:SetAllPoints(HideButton);
    ...
    ItemRow.updateIcon = function ()
        ...
        if (AwardDetails) then
            if (AwardDetails.awardedTo == GL.Exporter.disenchantedItemIdentifier) then
                CountDownBar:SetIcon("Interface/AddOns/DahBooCustomizedGargul/Assets/Icons/disenchant");
                ItemRow.awarded = true;
            else
                CountDownBar:SetIcon("Interface/AddOns/DahBooCustomizedGargul/Assets/Icons/trophy");
