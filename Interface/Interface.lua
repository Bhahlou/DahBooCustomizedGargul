...
function Interface:addMoveButton(Element)
    ...
    Move.normalTexture:SetTexture("Interface/AddOns/DahBooCustomizedGargul/Assets/Buttons/panel-move-up");
    ...
    Move.pushedTexture:SetTexture("Interface/AddOns/DahBooCustomizedGargul/Assets/Buttons/panel-move-down");
...
function Interface:addOptionsButton(Element)
    ...
    Options.normalTexture:SetTexture("Interface/AddOns/DahBooCustomizedGargul/Assets/Buttons/panel-cogwheel-up");
    ...
    Options.pushedTexture:SetTexture("Interface/AddOns/DahBooCustomizedGargul/Assets/Buttons/panel-cogwheel-down");
