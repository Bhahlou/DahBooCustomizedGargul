...
GL.Interface.Settings.PlusTwos = {
    description = "With plus twos you can keep track of how many items have been awarded to each player. Players with a lower plus two value can be given a higher priority on rolls to help equalize loot distribution amongst players"
};
