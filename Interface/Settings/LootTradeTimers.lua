...
function LootTradeTimers:draw(Parent)
    ...
    TrophyIcon:SetImage("Interface\\AddOns\\DahBooCustomizedGargul\\Assets\\Icons\\trophy");
    ...
    DisenchantIcon:SetImage("Interface\\AddOns\\DahBooCustomizedGargul\\Assets\\Icons\\disenchant");
